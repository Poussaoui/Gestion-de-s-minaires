...
public class GestionReservations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxIdSem = new javax.swing.JComboBox<>();
        jComboBoxStatut = new javax.swing.JComboBox<>();
        jComboBoxIdPartic = new javax.swing.JComboBox<>();
        ...
        btnAnnuler.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/annuler.png"))); // NOI18N
        btnAnnuler.setText("Dernier");
        ...
        jLabel6.setText("Rechercher par ID Séminaire :");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Les informations :"));

        jLabel1.setText("Id Participant :");

        jLabel2.setText("Id Séminaire :");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jComboBoxStatut, 0, 330, Short.MAX_VALUE)
                    .addComponent(jComboBoxIdSem, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jComboBoxIdPartic, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jComboBoxIdPartic, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jComboBoxIdSem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
        ...
        jLabel7.setText("Nombre de réservation (inscrit) =");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(526, 526, 526)
                        .addComponent(btnAnnuler, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(26, 26, 26)
                            .addComponent(txtRechercher, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
    ...
    public void listBox() throws Exception {
        jComboBoxStatut.addItem("");
        jComboBoxStatut.addItem("annule");
        jComboBoxStatut.addItem("attente");
        jComboBoxStatut.addItem("inscrit");

        jComboBoxIdPartic.setModel(new DefaultComboBoxModel(new Participants().afficherIdParticipant().toArray()));
        jComboBoxIdSem.setModel(new DefaultComboBoxModel(new Seminaire().afficherIdSeminaire().toArray()));
    }
    ...
    public void tableModel() throws Exception {
        ...
        dt.addColumn("Numero Participant");
        dt.addColumn("ID Seminaire");
        dt.addColumn("Statut");
        //---------coper le table a  TableStg
        jTableReservations.setModel(dt);

    }

    public void AfficherReservations() throws Exception {

        //---------afficher la liste
        new Reservation().afficherToutReservations(dt);
    }
    ...
    private void btnAnnulerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnnulerActionPerformed
        try {
            if (JOptionPane.showConfirmDialog(null, "vous etes sur vous voulez annuler \nID PARTICIPANT : " + idPArti + " \nID SEMINAIRE :" + idSemin, "WARNING",
                    JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                        int i;
                        i = new Reservation().annuler_reservation(idPArti, idSemin);
                        if (i == 1) {
                            JOptionPane.showMessageDialog(null, "Reservation annulée", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
                            tableModel();
                            AfficherReservations();
                        } else {
                            JOptionPane.showMessageDialog(null, "Erreur d'annuler la reservation ", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
                        }
            } else {
                JOptionPane.showMessageDialog(null, "Operation Annulé", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception ex) {
    ...
    private void jTableReservationsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableReservationsMouseClicked
        try {
            ...
            indice = jTableReservations.getSelectedRow();
            btnAnnuler.setEnabled(true);
            idPArti = (Integer) dt.getValueAt(indice, 0);
            idSemin = (Integer) dt.getValueAt(indice, 1);
    ...
    private void btnRechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRechercherActionPerformed
        try {
            int i;
            i = new Reservation().Afficher_Reservation(dt, Integer.parseInt(txtRechercher.getText()));
            if (i != 0) {
                tableModel();
                new Reservation().Afficher_Reservation(dt, Integer.parseInt(txtRechercher.getText()));
            } else {
                JOptionPane.showMessageDialog(null, "Aucaune participant trouvé", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionReservations.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
// <editor-fold defaultstate="collapsed" desc="Variables declaration">
    ...
    private javax.swing.JComboBox<String> jComboBoxIdPartic;
    private javax.swing.JComboBox<String> jComboBoxIdSem;
