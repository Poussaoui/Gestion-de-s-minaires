...
public class GestionAnimateurs extends javax.swing.JFrame {

    public GestionAnimateurs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableAnimateurs = new javax.swing.JTable();
        ...
        jTableAnimateurs.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableAnimateurs.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableAnimateursMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableAnimateurs);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtPrenom, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
    ...
    public void Afficheranimateurs() throws Exception {
        Animateur anim = new Animateur();
        DefaultTableModel dt;
        Statement stmt;
        //---------Remplir le table 
        dt = new DefaultTableModel();
        dt.addColumn("Numero Animateur");
        dt.addColumn("Nom");
        dt.addColumn("Prenom");
        ...
        jTableAnimateurs.setModel(dt);
        //---------afficher la liste
        anim.afficherToutsAnimateurs(dt);
    }
    ...
    private void jTableAnimateursMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAnimateursMouseClicked

    }//GEN-LAST:event_jTableAnimateursMouseClicked
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(GestionAnimateurs.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionAnimateurs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionAnimateurs().setVisible(true);
            }
        });
    }
...
// <editor-fold defaultstate="collapsed" desc="Variables declaration">
    ...
    private javax.swing.JTable jTableAnimateurs;
