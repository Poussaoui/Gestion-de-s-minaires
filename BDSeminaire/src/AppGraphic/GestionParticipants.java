...
public class GestionParticipants extends javax.swing.JFrame {

    Participants parti;
    DefaultTableModel dt;

    public GestionParticipants() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableParticipant.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableParticipant.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableParticipantMouseClicked(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtAdresse, javax.swing.GroupLayout.DEFAULT_SIZE, 334, Short.MAX_VALUE)
                    .addComponent(txtTel)
    ...
    public void AfficherParticipants() throws Exception {
        //---------afficher la liste
        parti.afficherToutParticipants(dt);
    }
    ...
    private void jTableParticipantMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableParticipantMouseClicked

    }//GEN-LAST:event_jTableParticipantMouseClicked

    private void btnAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjouterActionPerformed
        try {
            int i;
            i = parti.inserer_participant(txtPrenom.getText(), txtPrenom.getText());
            if (i == 1) {
                JOptionPane.showMessageDialog(null, "participant ajouté", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
                tableModel();
                AfficherParticipants();
            } else {
                JOptionPane.showMessageDialog(null, "Erreur d'ajouter un participant ", "InfoBox: " + "titleBar", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void btnRechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRechercherActionPerformed
        try {
            int i;
            i = parti.Afficher_Participants(dt,Integer.parseInt(txtRechercher.getText()));
            if (i != 0) {
                tableModel();
                parti.Afficher_Participants(dt,Integer.parseInt(txtRechercher.getText()));
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionParticipants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new GestionParticipants().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(GestionParticipants.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
