...
public class GestionConferenciers extends javax.swing.JFrame {

    public GestionConferenciers() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableConferencier = new javax.swing.JTable();
        ...
        jTableConferencier.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableConferencier.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableConferencierMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableConferencier);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtPrenom, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
    ...
    public void AfficherConferencier() throws Exception {
        Conferenciers conf = new Conferenciers();
        ...
        jTableConferencier.setModel(dt);
        //---------afficher la liste
        conf.afficherToutConferencier(dt);
    }
    ...
    private void jTableConferencierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableConferencierMouseClicked

    }//GEN-LAST:event_jTableConferencierMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionConferenciers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionConferenciers().setVisible(true);
            }
        });
    }
...
// <editor-fold defaultstate="collapsed" desc="Variables declaration">
    ...
    private javax.swing.JTable jTableConferencier;
